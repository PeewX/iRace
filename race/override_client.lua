...
--[[function clientwindd (winner)
		triggerServerEvent("onPlayerDestructionDerbyWin", winner)
end
addEvent("onPlayerClinetWin",true)
addEventHandler("onPlayerClinetWin",getRootElement(),clientwindd)]]